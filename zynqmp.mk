...
all: tfa optee-os u-boot linux dtbo buildroot image
clean: tfa-clean optee-os-clean u-boot-clean linux-clean dtbo-clean buildroot-clean image-clean
...
# Boot Image
###############################################################################
FIRMWARE_TARBALL = $(subst zynqmp-,2018.2-,$(PLATFORM))-release.tar.xz
